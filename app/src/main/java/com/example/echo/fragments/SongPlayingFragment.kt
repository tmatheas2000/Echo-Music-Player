...
class SongPlayingFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            _songTitle = arguments?.getString("songTtile")
            ...
            Statified.currentSongHelper?.currentPosition = Statified.currentPosition
            Statified.Staticated.updateTextViews(
                Statified.currentSongHelper?.songTitle as String,
                Statified.currentSongHelper?.songArtist as String
            )
        } catch (e: Exception) {
        ...
        var fromFavBottomBar = arguments?.get("FavButtomBar") as? String
        ...
        Statified.Staticated.processInformation(Statified.mediaplayer as MediaPlayer)
        ...
        Statified.mediaplayer?.setOnCompletionListener {
            Statified.Staticated.onSongComplete()
        }
        clickHandler()
        ...
        var prefsForShuffle = Statified.myActivity?.getSharedPreferences(
            Statified.Staticated.MY_PREFS_SHUFFLE,
    ...
    fun clickHandler() {
        ...
        Statified.shuffleImageButton?.setOnClickListener({
            ...
            var editorLoop = Statified.myActivity?.getSharedPreferences(
                Statified.Staticated.MY_PREFS_LOOP,
                Context.MODE_PRIVATE
            )?.edit()
            if (Statified.currentSongHelper?.isShuffle as Boolean) {
                Statified.shuffleImageButton?.setBackgroundResource(R.drawable.shuffle_white_icon)
        ...
        Statified.nextImageButton?.setOnClickListener({
            ...
            Statified.playPauseImageButton?.setBackgroundResource(R.drawable.pause_icon)
            if (Statified.currentSongHelper?.isShuffle as Boolean) {
                Statified.Staticated.playNext("PlayNextLikeNormalShuffle")
            } else {
                Statified.Staticated.playNext("PlayNextNormal")
            }
        })
